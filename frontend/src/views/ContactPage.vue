    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center max-w-5xl mx-auto">
      ...
      <div class="flex-1 rounded-xl p-5 bg-gray-800 flex flex-col gap-2">
        ...
        <p class="text-white/90 text-xs leading-relaxed">
          Plot 3 Peter Obang Close, Off O. P. Fingesi Street<br />Utako District, Abuja, FCT
        </p>
      </div>
      ...
      <div class="bg-gray-50 rounded-xl p-8">
        ...
        <div class="flex flex-col gap-4 text-sm text-gray-600">
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              <p>+234 (0) 917 562 2222</p>
              <p>+234 (0) 809 250 0003</p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              <a href="https://deutschepartners.com" target="_blank" class="text-green-700 hover:underline">
                https://deutschepartners.com
              </a>
            </div>
          </div>
        </div>
