  ...
  <div class="w-full">
    ...
    <section class="max-w-7xl mx-auto px-4 py-20 space-y-32">
      ...
      <div class="relative flex flex-col md:flex-row items-start gap-0">
        ...
        <div class="bg-neutral-900 text-white p-10 rounded-lg w-full md:w-[380px] h-[500px] flex flex-col justify-between">
          <div>
            <h3 class="text-2xl font-semibold mb-4">Deutsche Asset</h3>
            <p class="text-gray-300 text-sm leading-relaxed">
              We provide a wide range of financial advisory and capital
              management services to our clients. Working closely with
              our clients to understand their objectives, we deliver
              tailored solutions backed by deep market insight and decades
      ...
      <div class="relative flex flex-col md:flex-row items-start gap-0">
        ...
        <div class="bg-neutral-900 text-white p-10 rounded-lg w-full md:w-[380px] h-[500px] flex flex-col justify-between">
          <div>
            <h3 class="text-2xl font-semibold mb-4">Thusang Securities</h3>
            <p class="text-gray-300 text-sm leading-relaxed">
